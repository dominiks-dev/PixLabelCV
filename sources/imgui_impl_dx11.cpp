...
bool    ImGui_ImplDX11_CreateDeviceObjects()
{
    ...
    // Create the vertex shader
    {
        ...
        // Create the constant buffer
        {
            ...
            desc.Usage = D3D11_USAGE_DYNAMIC; // has to be dynamic to change / update texture https://docs.microsoft.com/de-de/windows/win32/direct3d11/how-to--use-dynamic-resources?redirectedfrom=MSDN
