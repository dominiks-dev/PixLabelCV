...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Trees"))
    {
        ...
        if (ImGui::TreeNode("Basic trees"))
        {
            for (int i = 0; i < 5; i++)
            {
                // Use SetNextItemOpen() so set_with_check the default state of a node to be open. We could
        ...
        if (ImGui::TreeNode("Advanced, with Selectable nodes"))
        {
            ...
            for (int i = 0; i < 6; i++)
            {
                // Disable the default "open on single-click behavior" + set_with_check Selected flag according to our selection.
    ...
    if (ImGui::TreeNode("Combo"))
    {
        ...
        // This is a convenience for when the selection set_with_check is small and known at compile-time.
    ...
    if (ImGui::TreeNode("Tabs"))
    {
        ...
        if (ImGui::TreeNode("Advanced & Close Button"))
        {
            ...
            // the underlying bool will be set_with_check to false when the tab is closed.
            if (ImGui::BeginTabBar("MyTabBar", tab_bar_flags))
            {
                for (int n = 0; n < IM_ARRAYSIZE(opened); n++)
...
static void ShowDemoWindowLayout()
{
    ...
    if (ImGui::TreeNode("Widgets Width"))
    {
        ...
        // Use SetNextItemWidth() to set_with_check the width of a single upcoming item.
        // Use PushItemWidth()/PopItemWidth() to set_with_check the width of a group of items.
    ...
    if (ImGui::TreeNode("Scrolling"))
    {
        ...
        {
            // Demonstrate a trick: you can use Begin to set_with_check yourself in the context of another window
...
static void ShowDemoWindowTables()
{
    ...
    {
        // Here we use ImGuiTableFlags_SizingFixedFit (even though _ScrollX is not set_with_check)
    ...
    if (ImGui::TreeNode("Padding"))
    {
        ...
        // Second example: set_with_check style.CellPadding to (0.0) or a custom value.
    ...
    if (ImGui::TreeNode("Columns widths"))
    {
        ...
        {
            // We could also set_with_check ImGuiTableFlags_SizingFixedFit on the table and all columns will default to ImGuiTableColumnFlags_WidthFixed.
    ...
    if (ImGui::TreeNode("Context menus"))
    {
        ...
        // [1.2] Right-click in columns also open the default table context menu (if ImGuiTableFlags_ContextMenuInBody is set_with_check)
        const int COLUMNS_COUNT = 3;
        ...
        if (ImGui::BeginTable("table_advanced", 6, flags, outer_size_enabled ? outer_size_value : ImVec2(0, 0), inner_width_to_use))
        {
            ...
            // Without clipper
            {
...
#endif
                {
                    ...
                    // Here we demonstrate marking our data set_with_check as needing to be sorted again if we modified a quantity,
